...
class InventoryReleasedEventHandlerTest {
    ...
    @InjectMocks
    private InventoryReleasedEventHandler eventHandler;
    ...
    private InventoryReleasedEvent event;
    ...
    void setUp() {
        ...
        event = InventoryReleasedEvent.newBuilder()
    ...
    class GetDescriptorFullName {
        ...
        void getDescriptorFullName_returnsExpectedDescriptor() {
            ...
            assertThat(descriptor).isEqualTo(InventoryReleasedEvent.getDescriptor().getFullName());
        }
    }
    ...
    class Handle {
        ...
        void handle_success_delegatesToOrderSagaService() {
            ...
            then(orderSagaService).should().handleInventoryReleased(
                  orderId,
                  cartId,
                  messageId
            );
