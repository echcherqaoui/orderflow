...
class ReservationExtensionFailedEventHandlerTest {
    ...
    @InjectMocks
    private ReservationExtensionFailedEventHandler eventHandler;

    private final UUID orderId = UUID.randomUUID();
    private final String cartId = "cart-123";
    private final String reason = "LOCK_TIMEOUT";
    private final String messageId = "msg-" + UUID.randomUUID();
    private final String signature = "sig-abc-123";
    private final Instant now = Instant.now();

    private ReservationExtensionFailedEvent event;
    ...
    void setUp() {
        ...
        event = ReservationExtensionFailedEvent.newBuilder()
    ...
    class GetDescriptorFullName {
        ...
        void getDescriptorFullName_returnsExpectedDescriptor() {
            ...
            assertThat(descriptor).isEqualTo(ReservationExtensionFailedEvent.getDescriptor().getFullName());
        }
    }
    ...
    class Handle {
        ...
        void handle_success_delegatesToOrderSagaService() {
            ...
            then(orderSagaService).should().handleReservationExtensionFailed(
                  orderId,
                  messageId,
                  cartId,
                  reason,
