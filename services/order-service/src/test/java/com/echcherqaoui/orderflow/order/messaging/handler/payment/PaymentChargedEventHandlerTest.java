...
class PaymentChargedEventHandlerTest {
    ...
    @InjectMocks
    private PaymentChargedEventHandler eventHandler;
    ...
    private PaymentChargedEvent event;
    ...
    void setUp() {
        ...
        event = PaymentChargedEvent.newBuilder()
    ...
    class GetDescriptorFullName {
        ...
        void getDescriptorFullName_returnsExpectedDescriptor() {
            ...
            assertThat(descriptor).isEqualTo(PaymentChargedEvent.getDescriptor().getFullName());
        }
    }
    ...
    class Handle {
        ...
        void handle_success_delegatesToOrderSagaService() {
            ...
            then(orderSagaService).should().handlePaymentCharged(
                  orderId,
                  paymentIntentId,
                  messageId
            );
