...
class ExtendReservationCommandHandlerTest {
    ...
    @InjectMocks
    private ExtendReservationCommandHandler commandHandler;
    ...
    private ExtendReservationCommand command;
    ...
    void setUp() {
        ...
        command = ExtendReservationCommand.newBuilder()
    ...
    class GetDescriptorFullName {
        ...
        void getDescriptorFullName_returnsExpectedDescriptor() {
            ...
            assertThat(descriptor).isEqualTo(ExtendReservationCommand.getDescriptor().getFullName());
        }
    }
    ...
    class Handle {
        ...
        void handle_success_delegatesToReservationService() {
            ...
            then(reservationService).should().extendReservation(
                  cartId,
                  orderId.toString(),
                  orderId.toString(),
                  messageId
