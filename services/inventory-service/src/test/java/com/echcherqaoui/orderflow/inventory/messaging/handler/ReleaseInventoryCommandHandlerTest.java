...
class ReleaseInventoryCommandHandlerTest {
    ...
    @InjectMocks
    private ReleaseInventoryCommandHandler commandHandler;
    ...
    private ReleaseInventoryCommand command;
    ...
    void setUp() {
        ...
        command = ReleaseInventoryCommand.newBuilder()
    ...
    class GetDescriptorFullName {
        ...
        void getDescriptorFullName_returnsExpectedDescriptor() {
            ...
            assertThat(descriptor).isEqualTo(ReleaseInventoryCommand.getDescriptor().getFullName());
        }
    }
    ...
    class Handle {
        ...
        void handle_success_delegatesToReservationService() {
            ...
            then(reservationService).should().releaseReservation(
                  cartId,
                  orderId.toString(),
                  messageId
            );
